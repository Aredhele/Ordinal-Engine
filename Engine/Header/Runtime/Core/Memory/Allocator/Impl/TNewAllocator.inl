...
/* inline */ Tp* TNewAllocator<Tp>::Allocate(size_type n)
{
...
/// \return A pointer on the allocated memory
template<typename Tp>
/* inline */ void TNewAllocator<Tp>::Deallocate(pointer p)
{
    ::operator delete(p);
}
...
/* inline */ void TNewAllocator<Tp>::Construct(Up* p, Args&&... args)
{
...
/* inline */ void TNewAllocator<Tp>::Destroy(Up* p)
{
    p->~Up();
}
