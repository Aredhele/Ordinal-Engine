...
IF(NOT EXISTS ${ORDINAL_BIN_DIR})
    FILE(MAKE_DIRECTORY ${ORDINAL_BIN_DIR})
    FILE(MAKE_DIRECTORY ${ORDINAL_BIN_DIR_DBG})
    FILE(MAKE_DIRECTORY ${ORDINAL_BIN_DIR_REL})

    MESSAGE(STATUS "Created : Bin/, Bin/Debug, Bin/Release")
ENDIF()

IF(NOT EXISTS ${ORDINAL_LIB_DIR})
    FILE(MAKE_DIRECTORY ${ORDINAL_LIB_DIR})
    FILE(MAKE_DIRECTORY ${ORDINAL_LIB_DIR_DBG})
    FILE(MAKE_DIRECTORY ${ORDINAL_LIB_DIR_REL})
